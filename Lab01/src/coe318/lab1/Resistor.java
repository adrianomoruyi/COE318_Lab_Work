...
//is between 50 and -50, otherwise print an error message.
    ...
    {
        System.out.print("Error! Please input a voltage between -50V and 50V.");
    }
...
if (current >= -5 && current <= 5)
    {
        voltdata = resistdata*current;
    }
    else
    {
        System.out.print("Error! Please input a current between -5A and 5A.");
    }
...
//FIX THIS
        return (voltdata*(voltdata/resistdata));
    }
