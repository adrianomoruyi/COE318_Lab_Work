...
//Initialize the instance variables
    ...
    public ComplexNumber negate() {
        ComplexNumber neg = new ComplexNumber(-real, -imag);
        return neg; 
    }
    ...
    public ComplexNumber add(ComplexNumber z) {
        ...
        ComplexNumber sum = new ComplexNumber(real + z.getReal(),imag + z.getImaginary());
        return sum; 
    }
    ...
    public ComplexNumber subtract(ComplexNumber z) {
         ComplexNumber diff = new ComplexNumber(real - z.getReal(),imag - z.getImaginary());
        return diff; 
    }
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        ComplexNumber product = new ComplexNumber((real * z.getReal()) - (imag*z.getImaginary()),(real*z.getImaginary() + (imag*z.getReal())));
        return product; 
    }
    ...
    public ComplexNumber reciprocal() {
         ComplexNumber recip = new ComplexNumber(real/(Math.pow(real,2) + Math.pow(imag,2)), -(imag/(Math.pow(real,2) + Math.pow(imag,2))));
        return recip; 
    }
    ...
    public ComplexNumber divide(ComplexNumber z) {
         ComplexNumber divid = new ComplexNumber(((real*z.getReal() + imag*z.getImaginary())/(Math.pow(z.getReal(),2) + Math.pow(z.getImaginary(), 2))),(imag*z.getReal() - real*z.getImaginary())/(Math.pow(z.getReal(),2) + Math.pow(z.getImaginary(), 2)));
        return divid; 
    }
